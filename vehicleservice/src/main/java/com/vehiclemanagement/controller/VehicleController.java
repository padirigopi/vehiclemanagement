...
public class VehicleController {
	...
	public @ResponseBody Vehicle createVehicle(@RequestBody Vehicle veh) {
	...
	public @ResponseBody Vehicle deleteVehicle(@PathVariable("id") String vID) {
		System.out.println("Delete Vhicle");
		logger.info("Start deleteVehicle.");
		Vehicle veh = new Vehicle();
		veh.setVehicleID("555");
